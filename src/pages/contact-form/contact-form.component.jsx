      ...
      <Jumbotron className="contact-jumbotron">
        <Row>
          <Col className="d-flex justify-content-center flex-wrap">
            <div className="m-2">
              <a
                href="mailto:jt0729@stanford.edu"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button variant="success" title="jt0729@stanford">
            ...
            <div className="m-2">
              <a
                href="https://www.facebook.com/john.tuguldur.7"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <div className="m-2">
              <a
                href="https://twitter.com/JohnTuguldur"
                target="_blank"
                rel="noopener noreferrer"
              >
